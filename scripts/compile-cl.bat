@echo off setlocal set "SCRIPT_DIR=%~dp0"
        ...
        echo == ==
        == == == == == == == == == == == == == == == == == == == == == == == == == == == ==
        echo AutoGitPull - Release Build with MSVC echo == == == == == == == == == == == == == == ==
        == == == == == == == == == == == == == == ==
        ...
        where cl > nul 2 >
            nul if errorlevel 1(echo MSVC cl compiler not found in PATH.exit / b 1)
                ...
                cl
                / nologo / std : c++ 20 / EHsc / O2 / DNDEBUG / D YAML_CPP_STATIC_DEFINE
    ^ / I "%INC%" - Iinclude ^
    ...
    src\parse_utils.cpp src\lock_utils.cpp src\process_monitor.cpp src\help_text
        .cpp src\linux_daemon.cpp src\windows_service.cpp
    ^
    ...
    ^ / Fedist\autogitpull.exe
          ...
          if errorlevel 1(echo Build failed.exit /
                          b 1) else(echo Build completed successfully.Binary : dist\autogitpull.exe)
