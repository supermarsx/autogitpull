@echo off setlocal set "SCRIPT_DIR=%~dp0"
    ...
    nul if errorlevel 1(echo MinGW g++ not found.Attempting to
        ...
        std =
    c++ 20 - static - I "%LIBGIT2_INC%" -
    Iinclude..\src\autogitpull.cpp..\src\git_utils.cpp..\src\tui.cpp..\src\logger.cpp.
        .\src\resource_utils.cpp..\src\system_utils.cpp..\src\time_utils.cpp..\src\config_utils.cpp.
        .\src\debug_utils.cpp..\src\options.cpp..\src\lockfile.cpp..\src\parse_utils.cpp
