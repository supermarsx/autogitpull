...
void print_help(const char* prog) {
    static const std::vector<OptionInfo> opts = {
        ...
        {"--interval", "-i", "<N[s|m|h|d|w|M|Y]>", "Delay between scans", "Basics"},
        ...
        {"--updated-since", "", "<N[m|h|d|w|M|Y]>", "Only sync repos updated recently", "Basics"},
        ...
        {"--mutant", "", "", "Enable full auto mutant mode with adaptive timeouts", "Process"},
        {"--recover-mutant", "", "", "Recover persisted mutant session", "Process"},
        {"--mutant-config", "", "<file>", "Path to mutant config file", "Process"},
        ...
        {"--hard-reset", "", "", "Remove logs, configs, and lock files", "Actions"},
        ...
        {"--cpu-poll", "", "<N[s|m|h|d|w|M|Y]>", "CPU usage polling interval", "Tracking"},
        {"--mem-poll", "", "<N[s|m|h|d|w|M|Y]>", "Memory usage polling interval", "Tracking"},
        {"--thread-poll", "", "<N[s|m|h|d|w|M|Y]>", "Thread count polling interval", "Tracking"},
